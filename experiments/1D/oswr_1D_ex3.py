...
global_fig, global_ax = plot_wireframe(vert1D, time_grid, heat_solution1D.T, xlabel=r'$x$', ylabel=r'$t$', xlim=(0, 1), ylim=(t0, T), azim = 255, elev = 15)
...
# Save the figures
plt.tight_layout()
global_fig.savefig(f"figures/1D/fem/ex3/fem_{T}.png", dpi = 300, bbox_inches = 'tight')
subdomain_fig.savefig(f"figures/1D/oswr/ex3/subdomains_{T}.png", dpi = 300, bbox_inches = 'tight')
iterates_fig.savefig(f"figures/1D/oswr/ex3/iterates_{T}.png", dpi = 300, bbox_inches = 'tight')
plt.show()
