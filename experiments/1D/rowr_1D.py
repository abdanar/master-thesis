...
visualizer1D.plot_iteration(data = global_history, dpi = 150, ylabel = rf"$\| u_{{exact}} - u_{{ROSWR}} \|_{{L^2(0,{T};L^2({vert1D[0]}, {vert1D[-1]}))}}$", save_path="figures/1D/roswr/fig1D_global_rom(exact).png",
