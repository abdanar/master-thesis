...
oswr_solution1D = oswrproblem1D.solve(ntime = ntime, theta = 0.5, lift = 'nodal', method = 'RAS', omega = 1.0, maxiter = 100, tol = 1e-3)
...
# Define Schwarz problem with 2 subdomains and overlap of 1 layer of elements
oswrproblem2D = OSWRProblem(femspace = femspace2D, t0 = t0, T = T, f = func2D, g = exact2D, h = h2D, n = 2, overlap = 1)

# Solve the problem using the Schwarz method with RAS, nodal lifting and theta method with theta = 0.5 (Crank-Nicolson)
oswr_solution = oswrproblem2D.solve(ntime = ntime, theta = 0.5, lift = 'nodal', method = 'RAS', omega = 1.0, maxiter = 100, tol = 1e-3)

# Solve the problem using the Schwarz method with RAS, nodal lifting and theta method with theta = 0.5 (Crank-Nicolson), while tracking convergence history
# oswr_solution = oswrproblem2D.solve(ntime = ntime, theta = 0.5, lift = 'nodal', method = 'RAS', omega = 1.0, maxiter = 100, tol = 1e-3, history = True, uh = heat_solution2D, exact = exact2D)
...
visualizer2D.plot_convergence(error_history = oswrproblem2D.error_history, linewidth = 0.8, markersize = 3)